        ...
        if(isset($coupon_id) && $coupon_id == ""){
            ...
            if($return){
                ...
                foreach ($cuponUser as $key=>$users){
                    ...
                    $to 	 = $users['email'];
                    $from 	 = 'admin@karibbeandelight.com';
                    $subject = $amount."discount on orders in Karibbean Delight";
                    $body 	 = 'Dear '.$users["customer_name"].'</br>You have been offered'. $amount.' discount on your order in OurBurritoBrothers. 
                        ...
                        Best Regards</br><b>Karibbean Delight</b></br></br>Note: Please Do not reply this email.';
