	...
	load_grid = function load_grid(){
		...
		$.ajax({
			...
			success: function(data) {
				...
				html +='<button class="no-print" onclick="window.print()">Print</button><div width="100%"  style="text-align:center"><img src="'+project_url+'<?php echo $logo; ?>" width="80"/></div><h2 style="text-align:center">Karibbean Delight</h2><h4 style="text-align:center">Order Summary Report</h4><table width="100%"><tr><th width="60%" style="text-align:left"><small>'+serach_areas+'</small></th><th width="40%"  style="text-align:right"><small>Printed By: '+user_name+', Date:'+todate+'</small></th></tr></table>';
