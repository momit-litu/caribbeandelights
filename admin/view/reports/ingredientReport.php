            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if($.trim(search_txt) == "Print"){
                        ...
                        html +='<button class="no-print" onclick="window.print()">Print</button><div width="100%"  style="text-align:center"><img src="'+project_url+'<?php echo $logo; ?>" width="80"/></div><h2 style="text-align:center">Karibbean Delight</h2><h4 style="text-align:center">Ingredient Report</h4><table width="100%"><tr><th width="60%" style="text-align:left"><small>'+serach_areas+'</small></th><th width="40%"  style="text-align:right"><small>Printed By: '+user_name+', Date:'+todate+'</small></th></tr></table>';

                        if(!jQuery.isEmptyObject(data.records)){

                            html +='<table width="100%" cellpadding="10" border="1px" style="margin-top:10px;border-collapse:collapse"><thead><tr><th style="text-align:left">Id</th><th style="text-align:left">Name</th><th style="text-align:right">Price</th></tr></thead><tbody>';
                        ...
                        WinId = window.open("", "Ingredient Report","width=850,height=800,left=50,toolbar=no,menubar=YES,status=YES,resizable=YES,location=no,directories=no, scrollbars=YES");
                        WinId.document.open();
