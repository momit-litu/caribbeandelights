        ...
        <!-- Start Welcome Part-->
		 ...
		 <section id="reach-to" class="welcome-part home-icon">
			<div class="row" style="
			 ...
			 <a  href="https://www.tripadvisor.com/Restaurant_Review-g28970-d1073695-Reviews-Burrito_Brothers-Washington_DC_District_of_Columbia.html"   class="button-white" style="display: inline-block !important;border: 1px solid #green !important;padding: 6px 10px !important;border-radius: 4px !important; background-color: #fff; width:180px !important" ><img src="images/tripadvisor.png" /></a>
			</div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" >
                                ...
                                <div class="service-track-overlay banner-bg" style="background-color: #2d9734" onclick="pickup_order()">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" id="groupOrder">
                                ...
                                <div class="service-track-overlay banner-bg" onclick="delivery_order()" style="background-color: #2d9734">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" >
                                ...
                                <div class="service-track-overlay banner-bg" style="background-color: #2d9734" onclick="group_order()">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                                    <h3>Group <span>Order</span></h3>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" id="groupOrder">
                                ...
                                <div class="service-track-overlay banner-bg" onclick="catering()" style="background-color: #2d9734">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                                    <h3>Catering <span>Service</span></h3>
