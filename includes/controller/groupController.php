            ...
            WHERE go.order_id ='$invoice_no' OR go.invoice_no = '$invoice_no'";
                    ...
                    <div id='order-div'>
                        <div class='title text-center' style='text-align: center'>
                            <img src='".$dbClass->getDescription("website_url")."admin/images/banner/logo.png' alt='' style='alignment: center'>
